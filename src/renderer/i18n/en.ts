...
const lang = {
  ...
  ui: {
    ...
    actions: {
      ...
      openImageLibrary: "Select Generated Images",
      cancel: "Cancel",
      ok: "OK",
      apply: "Apply",
      ...
      generateReference: "Generate Material",
  ...
  presentationStyle: {
    styleTemplate: {
      ...
      description: "Overwrite the style. Be careful as the existing style settings and material settings will be lost.",
