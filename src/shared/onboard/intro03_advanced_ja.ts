  ...
  beats: [
    {
      ...
      speaker: "ai_expert",
      text: "ForDoAnalysis改の基本はマスターしましたね。ここからは、さらに高度な機能で、あなたの創造性をネクストレベルに引き上げます。",
      imagePrompt:
    ...
    },
    {
      ...
      speaker: "tech_guide",
      text: "ForDoAnalysis改には、あなたのスキルに合わせたモードがあります。入門モードから始め、慣れてきたら中級モードのAIチャット機能や、上級モードの詳細設定、多彩なスライドテンプレートに挑戦してみましょう。",
      image: {
        type: "markdown",
        markdown: [
          "# ⚙️ スキルに合わせた制作モード",
    ...
    },
    {
      ...
      speaker: "tech_guide",
      text: "このように、ForDoAnalysis改では様々な形式のスライドを組み合わせることで、表現力豊かな動画コンテンツを効率的に制作できます。",
      image: {
        type: "markdown",
        markdown: [
    ...
    },
    {
      ...
      speaker: "creator_pro",
      text: "これで、あなたもAIクリエイターの仲間入りです。技術の力を借りながら、人間らしい創造性を発揮してください。ForDoAnalysis改ならできる、あなたも始められる！未来のコンテンツ制作は、あなたの手の中にあります。",
      imagePrompt:
